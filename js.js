...
document.onkeydown = function(event) {
 ...
 // Target each keypress and update the input screen
  ...
  // Cature operators and prevent from addint two consecutuve operators
    ...
    if ((inputVal != '' && operators.indexOf(lastChar) == -1 && key_code == 189 && event.shiftKey) || (key_code == 173)  || (inputVal != '' && operators.indexOf(lastChar) == -1 && key_code == 107)) {
        input.innerHTML += '-';
  }
